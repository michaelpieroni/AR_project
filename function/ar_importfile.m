function ALLDATA = ar_importfile(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   ALLDATA = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   ALLDATA = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   ALLDATA = importfile1('11092013184433_1_ALLDATA.txt', 2, 1833);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/05/08 16:59:52
